'''
This file contains the evolutionary framework for performing tests
on data sets with the CPPN. 

All code very similar to the main deap ea file but is configured 
specifically to run the data set testing examples for the CPPN
'''
